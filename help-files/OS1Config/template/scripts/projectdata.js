...
rh.consts('HELP_ID', '87975820-EEC2-4089-9947-AC8D8EBFC2E9' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Configurazione OS1 Enterprise - by OSItalia S.r.l.");
